...
if __name__ == '__main__':
    default_values = input('Enter dictionary list of default values(separated '
    ...
    while True:
        ...
        print("5.Insert dictionary node at the end of the list")
        print("6.insert dictionary node after dictionary specified node")
        print("7.Insert dictionary node before dictionary specified node")
        print("8.insert dictionary node at dictionary given position")
        ...
        if option == 1:
            ...
            if my_list.has_cycle():
                ...
                print("List do not have dictionary cycle")
        elif option == 18:
